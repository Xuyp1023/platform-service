...
public class NotificationSubscribeDubboService implements INotificationSubscribeService {
    ...
    @Override
    public String webQuerySubscribeByCustNo(final Long anCustNo, final int anFlag, final int anPageNum,
            final int anPageSize) {
        return AjaxObject.newOkWithPage("查询订阅列表成功!",
                subscribeService.queryProfileSubscribe(anCustNo, anFlag, anPageNum, anPageSize)).toJson();
    }

    @Override
    public String webCancelSubscribe(final Long anCustNo, final Long anSourceCustNo, final String anProfileName,
    ...
    @Override
    public String webConfirmSubscribe(final Long anCustNo, final Long anSourceCustNo, final String anProfileName,
            final String anChannel) {
