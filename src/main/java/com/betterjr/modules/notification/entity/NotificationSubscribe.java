...
public class NotificationSubscribe implements BetterjrEntity {
    ...
    public void setChannelProfileId(final Long anChannelProfileId) {
    ...
    public void setSourceCustNo(final Long sourceCustNo) {
    ...
    public boolean equals(final Object that) {
        ...
        final NotificationSubscribe other = (NotificationSubscribe) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getSourceCustNo() == null ? other.getSourceCustNo() == null
                        : this.getSourceCustNo().equals(other.getSourceCustNo()))
     ...
     * @param anCustomer
     */
    public void initAddValue(final Long anCustNo, final Long anSourceCustNo, final String anProfileName,
            final String anChannel, final CustOperatorInfo anOperator, final CustInfo anCustomer) {
