...
public interface NotificationSubscribeMapper extends Mapper<NotificationSubscribe> {
    ...
    public List<ChannelSubscribeModel> selectChannelSubscribe(@Param("custNo") Long custNo,
            @Param("sourceCustNo") Long sourceCustNo, @Param("profileName") String profileName);
}