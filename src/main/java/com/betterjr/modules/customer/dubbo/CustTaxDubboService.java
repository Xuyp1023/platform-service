...
public class CustTaxDubboService implements ICustTaxService {
    ...
    public String webAddTaxRecord(Map<String, Object> anParam, String anFileList) {
        ...
        anCustTaxRecord
                .setBatchNo(custFileItemService.updateCustFileItemInfo(anFileList, anCustTaxRecord.getBatchNo()));
    ...
    public String webQueryTaxRecordList(Long anCustNo, String anFlag, int anPageNum, int anPageSize) {
        return AjaxObject.newOkWithPage("纳税信息查询成功",
                custTaxRecordService.queryCustTaxRecordList(anCustNo, anFlag, anPageNum, anPageSize)).toJson();
    }
