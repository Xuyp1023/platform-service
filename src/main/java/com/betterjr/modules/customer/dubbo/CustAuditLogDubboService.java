...
public class CustAuditLogDubboService implements ICustAuditLogService {
    ...
    public String webQueryAuditLogOpenAccountList(Long anBusinId) {
        return AjaxObject.newOk("开户 审核日志-列表查询 成功",
                auditLogService.queryCustAuditLogByAuditType(anBusinId, CustomerConstants.AUDIT_TYPE_OPENACCOUNT))
                .toJson();
    }

    @Override
    public String webQueryAuditLogInsteadApplyList(Long anBusinId) {
        return AjaxObject.newOk("代录申请 审核日志-列表查询 成功",
                auditLogService.queryCustAuditLogByAuditType(anBusinId, CustomerConstants.AUDIT_TYPE_INSTEADAPPLY))
                .toJson();
    }

    @Override
    public String webQueryAuditLogInsteadRecordList(Long anBusinId) {
        return AjaxObject.newOk("代录记录 审核日志-列表查询 成功",
                auditLogService.queryCustAuditLogByAuditType(anBusinId, CustomerConstants.AUDIT_TYPE_INSTEADRECORD))
                .toJson();
    }

    @Override
    public String webQueryAuditLogChangeApplyList(Long anBusinId) {
        return AjaxObject.newOk("变更申请 审核日志-列表查询 成功",
                auditLogService.queryCustAuditLogByAuditType(anBusinId, CustomerConstants.AUDIT_TYPE_CHANGEAPPLY))
                .toJson();
    }
