...
public class CustRelationAuditService extends BaseService<CustRelationAuditMapper, CustRelationAudit> {
    ...
    public int addAuditCustRelation(CustRelation anCustRelation, String anAuditAgency, String anAuditOpinion,
            String anTaskName) {
    ...
    public int addRefuseCustRelation(CustRelation anCustRelation, String anAuditAgency, String anAuditOpinion,
            String anTaskName) {
        CustRelationAudit relationAudit = new CustRelationAudit();
