...
public class CustBankFlowRecordService extends BaseService<CustBankFlowRecordMapper, CustBankFlowRecord> {
     ...
     * @return
     */
    public Page<CustBankFlowRecord> queryCustBankFlowRecord(Long anCustNo, String anFlag, int anPageNum,
            int anPageSize) {
        BTAssert.notNull(anCustNo, "客户编号不允许为空！");

        Page<CustBankFlowRecord> recordList = this.selectPropertyByPage("custNo", anCustNo, anPageNum, anPageSize,
                "1".equals(anFlag));
        // 补充文件信息
