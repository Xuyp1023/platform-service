...
public class CustMechFinanceRecordService extends BaseService<CustMechFinanceRecordMapper, CustMechFinanceRecord> {
     ...
     * @return
     */
    public Page<CustMechFinanceRecord> queryCustMechFinanceRecord(Long anCustNo, String anFlag, int anPageNum,
            int anPageSize) {
        BTAssert.notNull(anCustNo, "客户编号不允许为空！");
        Map<String, Object> anMap = new HashMap<String, Object>();
        anMap.put("custNo", anCustNo);
        Page<CustMechFinanceRecord> financeRecordList = selectPropertyByPage(anMap, anPageNum, anPageSize,
                "1".equals(anFlag));
        // 补充文件信息
