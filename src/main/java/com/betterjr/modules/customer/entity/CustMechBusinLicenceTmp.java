...
public class CustMechBusinLicenceTmp implements BetterjrEntity {
    ...
    public void initModifyValue(final CustMechBusinLicenceTmp anCustMechBusinLicenceTmp) {
        this.id = anCustMechBusinLicenceTmp.getId();
/*
...
*/
        ...
        this.businStatus = anCustMechBusinLicenceTmp.getBusinStatus();
        this.operOrg = anCustMechBusinLicenceTmp.getOperOrg();
    }
}