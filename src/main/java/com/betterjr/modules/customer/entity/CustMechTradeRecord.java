...
@Entity
@Table(name = "t_cust_mech_trade_record")
public class CustMechTradeRecord implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        CustMechTradeRecord other = (CustMechTradeRecord) that;
    ...
    public void initAddValue() {
        this.id = SerialGenerator.getLongValue("CustMechTradeRecord.id");
    ...
    public void initModifyValue(final CustMechTradeRecord anCustMechTradeRecord) {
        this.id = anCustMechTradeRecord.getId();
/*
...
*/
        ...
        this.businStatus = anCustMechTradeRecord.getBusinStatus();
        this.operOrg = anCustMechTradeRecord.getOperOrg();
    }
}