...
@Entity
@Table(name = "t_cust_mech_finance_record")
public class CustMechFinanceRecord implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
     ...
     * 报表名称
     */
    @Column(name = "C_REPORT_NAME", columnDefinition = "VARCHAR")
    @MetaData(value = "报表名称", comments = "报表名称")
    private String reportName;

    /**
     * 报表类型:0财务报表 1应付账款 2应收账款
     */
    @Column(name = "C_REPORT_TYPE", columnDefinition = "CHAR")
    @MetaData(value = "报表类型:0财务报表 1应付账款 2应收账款", comments = "报表类型:0财务报表 1应付账款 2应收账款")
    ...
    @MetaData(value = "状态：0未导入  1导入成功 2导入失败", comments = "状态：0未导入  1导入成功 2导入失败")
    ...
    public boolean equals(Object that) {
        ...
        CustMechFinanceRecord other = (CustMechFinanceRecord) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getVersion() == null ? other.getVersion() == null
                        : this.getVersion().equals(other.getVersion()))
                && (this.getReportName() == null ? other.getReportName() == null
                        : this.getReportName().equals(other.getReportName()))
                && (this.getReportType() == null ? other.getReportType() == null
                        : this.getReportType().equals(other.getReportType()))
    ...
    public void initAddValue() {
        this.id = SerialGenerator.getLongValue("CustMechFinanceRecord.id");
