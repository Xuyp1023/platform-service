...
public class CustMajor implements BetterjrEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getCustNo() == null ? other.getCustNo() == null : this.getCustNo().equals(other.getCustNo()))
                ...
                && (this.getCustCorp() == null ? other.getCustCorp() == null
                        : this.getCustCorp().equals(other.getCustCorp()))
                && (this.getCustType() == null ? other.getCustType() == null
                        : this.getCustType().equals(other.getCustType()))
                && (this.getBusinMode() == null ? other.getBusinMode() == null
                        : this.getBusinMode().equals(other.getBusinMode()))
