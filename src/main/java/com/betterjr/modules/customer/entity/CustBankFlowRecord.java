...
@Entity
@Table(name = "t_cust_bankflow_record")
public class CustBankFlowRecord implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
    ...
    private static final long serialVersionUID = 1468812783841L;
    ...
    public boolean equals(Object that) {
        ...
        CustBankFlowRecord other = (CustBankFlowRecord) that;
    ...
    public void initAddValue() {
        this.id = SerialGenerator.getLongValue("CustBankFlowRecord.id");
