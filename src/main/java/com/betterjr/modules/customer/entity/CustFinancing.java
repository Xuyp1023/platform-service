...
public class CustFinancing implements BetterjrEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getGuaranteeType() == null ? other.getGuaranteeType() == null
                        : this.getGuaranteeType().equals(other.getGuaranteeType()))
                && (this.getBusinType() == null ? other.getBusinType() == null
                        : this.getBusinType().equals(other.getBusinType()))
                && (this.getFinancingOrg() == null ? other.getFinancingOrg() == null
                        : this.getFinancingOrg().equals(other.getFinancingOrg()))
