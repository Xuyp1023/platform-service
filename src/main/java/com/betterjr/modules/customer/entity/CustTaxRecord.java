...
@Entity
@Table(name = "t_cust_tax_record")
public class CustTaxRecord implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
     ...
     * 类型:0数据报表 1证明文件
     */
    @Column(name = "C_TAX_TYPE", columnDefinition = "CHAR")
    @MetaData(value = "类型:0数据报表 1证明文件", comments = "类型:0数据报表 1证明文件")
    ...
    private static final long serialVersionUID = 1468812783875L;
    ...
    public boolean equals(Object that) {
        ...
        CustTaxRecord other = (CustTaxRecord) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getVersion() == null ? other.getVersion() == null
                        : this.getVersion().equals(other.getVersion()))
                && (this.getTaxType() == null ? other.getTaxType() == null
                        : this.getTaxType().equals(other.getTaxType()))
    ...
    public void initAddValue() {
        this.id = SerialGenerator.getLongValue("CustTaxRecord.id");
    ...
    public void initModifyValue(final CustTaxRecord anCustTaxRecord) {
        ...
        this.businStatus = anCustTaxRecord.getBusinStatus();
        this.operOrg = anCustTaxRecord.getOperOrg();
    }
}