...
public class CustChangeApply implements BetterjrEntity {
    ...
    @MetaData( value="变更项目: 0公司基本信息", comments = "变更项目: 0公司基本信息，1法人信息，2股东信息，3高管信息，4营业执照，5联系人信息，6银行账户")
    ...
    @MetaData( value="状态：0未审核 1审核通过 2审核驳回", comments = "状态：0未审核 1审核通过 2审核驳回")
    ...
    public void initModifyValue(final CustChangeApply anCustMechBaseTmp) {
