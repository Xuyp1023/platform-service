...
@Entity
@Table(name = "t_cust_mech_shareholder")
public class CustMechShareholder implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
    ...
    /**
     * 出资方式 0货币 1实物 2无形资产(工业产权和非专利技术) 3土地使用权
     */
    @Column(name = "C_INVESTMENT_TYPE", columnDefinition = "CHAR")
    @MetaData(value = "出资方式 0货币 1实物 2无形资产(工业产权和非专利技术) 3土地使用权", comments = "出资方式 0货币 1实物 2无形资产(工业产权和非专利技术) 3土地使用权")
    private String investmentType;

    /**
     * 出资比较例
     */
    @Column(name = "N_INVESTMENT_RATE", columnDefinition = "DOUBLE")
    @MetaData(value = "出资比较例", comments = "出资比较例")
    ...
    private static final long serialVersionUID = 1468812783869L;
    ...
    public String toString() {
        ...
        sb.append(", investmentRate=").append(investmentRate);
    ...
    public boolean equals(Object that) {
        ...
        CustMechShareholder other = (CustMechShareholder) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getInvestmentType() == null ? other.getInvestmentType() == null
                        : this.getInvestmentType().equals(other.getInvestmentType()))
                && (this.getInvestmentRate() == null ? other.getInvestmentRate() == null
                        : this.getInvestmentRate().equals(other.getInvestmentRate()))
