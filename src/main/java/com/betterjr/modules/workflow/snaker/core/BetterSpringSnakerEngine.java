...
public class BetterSpringSnakerEngine extends SpringSnakerEngine {
     ...
     * @return Execution
     */
    private Execution betterExecute(String taskId, String operator, Map<String, Object> args, String coreOperOrg,
     ...
     * @return Execution
     */
    private Execution betterExecute(Process process, String operator, Map<String, Object> args, String parentId,
    ...
    public List<Task> executeAndJumpTask(String taskId, String operator, Map<String, Object> args,
            Set<String> nodeNameList, String coreOperOrg, String financerOperOrg) {
     ...
     */
    public List<Task> executeTask(String taskId, String operator, Map<String, Object> args, String coreOperOrg,
            String financerOperOrg) {
        // 完成任务，并且构造执行对象
        Execution execution = betterExecute(taskId, operator, args, coreOperOrg, financerOperOrg);
        if (execution == null) return Collections.emptyList();
     ...
     */
    public List<Task> executeTaskOnly(String taskId, String operator, Map<String, Object> args, String coreOperOrg,
            String financerOperOrg) {
        // 完成任务，并且构造执行对象
        Execution execution = betterExecute(taskId, operator, args, coreOperOrg, financerOperOrg);
     ...
     */
    public Order startInstanceById(String id, String operator, Map<String, Object> args, String coreOperOrg,
            String financerOperOrg) {
        if (args == null) args = new HashMap<String, Object>();
        BetterProcessService processService = (BetterProcessService) process();
